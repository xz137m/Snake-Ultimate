...
const PET_TYPES = [
    { id: 'rock', name: 'Pet Rock', nameAr: 'صخرة أليفة', rarity: 'Common', rarityAr: 'شائع', color: '#888888', speed: 0.03, intel: 0.0, chance: 40, desc: "Dumb/Slow: Moves slowly towards fruits.", descAr: "بطيء: يتحرك ببطء نحو الفواكه." },
    { id: 'snail', name: 'Racing Snail', nameAr: 'حلزون السباق', rarity: 'Common+', rarityAr: 'شائع+', color: '#a1887f', speed: 0.05, intel: 0.1, chance: 25, desc: "Slow: Tries to gather fruits.", descAr: "بطيء: يحاول جمع الفواكه." },
    { id: 'rabbit', name: 'Speedy Bun', nameAr: 'أرنب سريع', rarity: 'Uncommon', rarityAr: 'غير شائع', color: '#00ffff', speed: 0.15, intel: 0.2, chance: 15, desc: "Fast/Dumb: Races towards fruits.", descAr: "سريع: يسابق نحو الفواكه." },
    { id: 'turtle', name: 'Ninja Turtle', nameAr: 'سلحفاة النينجا', rarity: 'Rare', rarityAr: 'نادر', color: '#00ff00', speed: 0.06, intel: 0.8, chance: 10, desc: "Slow/Killer: Slowly hunts enemies.", descAr: "بطيء/قاتل: يطارد الأعداء ببطء." },
    { id: 'wolf', name: 'Alpha Wolf', nameAr: 'الذئب ألفا', rarity: 'Epic', rarityAr: 'ملحمي', color: '#ff8000', speed: 0.12, intel: 0.6, chance: 6, desc: "Balanced: Hunts fruits and enemies.", descAr: "متوازن: يطارد الفواكه والأعداء." },
    { id: 'phoenix', name: 'Solar Phoenix', nameAr: 'عنقاء الشمس', rarity: 'Epic+', rarityAr: 'ملحمي+', color: '#ffeb3b', speed: 0.18, intel: 0.7, chance: 3, desc: "Fast/Balanced: Burns enemies.", descAr: "سريع/متوازن: يحرق الأعداء." },
    { id: 'dragon', name: 'Void Dragon', nameAr: 'تنين الفراغ', rarity: 'Legendary', rarityAr: 'أسطوري', color: '#9400d3', speed: 0.30, intel: 1.0, chance: 1, desc: "Legendary: Fast Killer. Destroys everything.", descAr: "أسطوري: قاتل سريع. يدمر كل شيء." }
];

const TRANSLATIONS = {
    en: {
        score: "Score:", level: "Level:", gold: "Gold:", highScore: "High Score:", play: "▶ Play", shop: "🛒 Shop", rebirth: "🌀 Rebirth", guide: "📜 Guide", settings: "⚙️ Settings", reset: "🗑️ Reset Data", gameOver: "Game Over!", finalScore: "Final Score:", goldEarned: "Gold Earned:", playAgain: "🔄 Play Again", mainMenu: "🏠 Main Menu", shopTitle: "🛒 Upgrade Shop", rebirthTitle: "🌀 Prestige Shop", guideTitle: "📜 Game Guide", settingsTitle: "⚙️ Settings", balance: "Balance:", close: "❌ Close", audioGame: "🔊 Audio & Gameplay", graphics: "🎨 Graphics & Performance", soundOn: "🔊 Sound: ON", soundOff: "🔊 Sound: OFF", particlesOn: "✨ Particles: ON", particlesOff: "✨ Particles: OFF", rangeOn: "📏 Show Range: ON", rangeOff: "📏 Show Range: OFF", nextEvo: "Next Evolution ({0} Length)", glowOn: "💡 Glow: ON", glowOff: "💡 Glow: OFF", brightness: "☀️ Brightness:", moreFood: "🍎 More Food", moreFoodDesc: "Increase max food on screen (+1)", 
        ...
        active: "✅ ACTIVE",
        inactive: "❌ INACTIVE",
        maxStaminaReq: "Max Stamina Lvl 10",
        slayerUnlocked: "⚔️ Slayer Upgrade Unlocked!",
        purchasedUpgrades: "⚔️ Purchased {0} Upgrades!",
        ...
        speed: "Speed:",
        intel: "Intel:",
        summonPet: "Summon Pet ({0} Souls)",
        notEnoughSouls: "Not enough souls! Need {0}",
        skip: "⏩ Skip",
        collectClose: "Collect & Close",
        petUnlocked: "🎉 UNLOCKED: {0}!",
        petDuplicate: "Duplicate {0}.",
        needGoldForRP: "You need at least {0} Gold to gain Rebirth Points!",
        prestigeUpgrade: "🌀 Prestige Upgrade Acquired!",
        maxUpgrades: "🌀 Max Upgrades Purchased!",
        rebirthReq: "Requires: Level {0} & {1} Gold",
        upgradeSuccess: "✅ Upgrade Successful!",
        yes: "✅ Yes",
        no: "❌ No"
    },
    ar: {
        score: "النقاط:", level: "المستوى:", gold: "الذهب:", highScore: "أعلى نقاط:", play: "▶ ابدأ اللعب", shop: "🛒 المتجر", rebirth: "🌀 إعادة ولادة", guide: "📜 الدليل", settings: "⚙️ الإعدادات", reset: "🗑️ إعادة تعيين", gameOver: "خسرت!", finalScore: "النقاط النهائية:", goldEarned: "الذهب المكتسب:", playAgain: "🔄 العب مجدداً", mainMenu: "🏠 القائمة الرئيسية", shopTitle: "🛒 متجر التطويرات", rebirthTitle: "🌀 متجر الولادة", guideTitle: "📜 دليل اللعبة", settingsTitle: "⚙️ الإعدادات", balance: "الرصيد:", close: "❌ إغلاق", audioGame: "🔊 الصوت واللعب", graphics: "🎨 الجرافيكس والأداء", soundOn: "🔊 الصوت: مفعل", soundOff: "🔊 الصوت: معطل", particlesOn: "✨ المؤثرات: مفعل", particlesOff: "✨ المؤثرات: معطل", rangeOn: "📏 المدى: مفعل", rangeOff: "📏 المدى: معطل", nextEvo: "التطور التالي (طول {0})", glowOn: "💡 التوهج: مفعل", glowOff: "💡 التوهج: معطل", brightness: "☀️ السطوع:", moreFood: "🍎 زيادة التفاح", moreFoodDesc: "زيادة عدد التفاح في الشاشة (+1)",
        ...
        qualityHigh: "💎 الجودة: عالية",
        qualityLow: "🚀 الجودة: منخفضة",
        ...
        active: "✅ نشط",
        inactive: "❌ غير نشط",
        maxStaminaReq: "لياقة قصوى مستوى 10",
        slayerUnlocked: "⚔️ تم فتح تطوير القاتل!",
        purchasedUpgrades: "⚔️ تم شراء {0} تطويرات!",
        bossFight: "👹 قتال الزعيم!",
        bossTimer: "👹 الزعيم:",
        spawnChance: "فرصة الظهور:",
        baseScore: "النقاط الأساسية:",
        baseGold: "الذهب الأساسي:",
        speed: "السرعة:",
        intel: "الذكاء:",
        summonPet: "استدعاء مرافق ({0} روح)",
        notEnoughSouls: "لا توجد أرواح كافية! تحتاج {0}",
        skip: "⏩ تخطي",
        collectClose: "جمع وإغلاق",
        petUnlocked: "🎉 تم فتح: {0}!",
        petDuplicate: "مكرر {0}.",
        needGoldForRP: "تحتاج على الأقل {0} ذهب لكسب نقاط الولادة!",
        prestigeUpgrade: "🌀 تم الحصول على تطوير الولادة!",
        maxUpgrades: "🌀 تم شراء الحد الأقصى!",
        rebirthReq: "يتطلب: مستوى {0} و {1} ذهب",
        upgradeSuccess: "✅ تم التطوير بنجاح!",
        yes: "✅ نعم",
        no: "❌ لا"
    }
};
